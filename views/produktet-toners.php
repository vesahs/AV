...
<div class="main-content">
    ...
    <div class="row">
        <div class="product">
            <div class="image">
                <img src="../resources/images/TonerForOilySkin.png" alt="TonerForOilySkin" class="img">
            </div>
        ...
        <div class="product">
            <div class="image">
                <img src="../resources/images/TonerForDrySkin.png" alt="TonerForDrySkin" class="img">
            </div>
            <div class="description">
                <div class="title-price">
                    <div class="title">
                        <h3>Toner For Dry Skin</h3>
                    </div>
                    <div class="price">
                        <p><b>Price:</b> 12€</p>
                    </div>
                ...
                <div class="product-description"></div>
                <p>
                    Toner for dry skin is like a hydrating oasis in a bottle. Formulated with nourishing ingredients
    ...
    <div class="row">
        <div class="product">
            <div class="image">
                <img src="../resources/images/AcneToner.png" alt="AcneToner" class="img">
            </div>
            <div class="description">
                <div class="title-price">
                    <div class="title">
                ...
                <div class="product-description"></div>
                <p>
                    A toner designed for acne-prone skin is a powerhouse against breakouts.
                    ...
                    clearer, smoother, and healthier-looking skin.
                </p>
            </div>
        </div>
